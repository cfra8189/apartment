...
export default function Contact() {
    return (
        <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8" style={{ marginTop: 'calc(-1 * var(--header-height))', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div
                aria-hidden="true"
